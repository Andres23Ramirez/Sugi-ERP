...
class OutflowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create outflow" do
    assert_difference('Outflow.count') do
      post outflows_url, params: { outflow: { amoun: @outflow.amoun, date: @outflow.date, description: @outflow.description } }
    end
  ...
  test "should update outflow" do
    patch outflow_url(@outflow), params: { outflow: { amoun: @outflow.amoun, date: @outflow.date, description: @outflow.description } }
