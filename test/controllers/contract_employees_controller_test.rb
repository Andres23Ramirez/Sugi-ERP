...
class ContractEmployeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contract_employee" do
    assert_difference('ContractEmployee.count') do
      post contract_employees_url, params: { contract_employee: { dateEnd: @contract_employee.dateEnd, dateStart: @contract_employee.dateStart, employee_id: @contract_employee.employee_id, salary: @contract_employee.salary } }
    end
  ...
  test "should update contract_employee" do
    patch contract_employee_url(@contract_employee), params: { contract_employee: { dateEnd: @contract_employee.dateEnd, dateStart: @contract_employee.dateStart, employee_id: @contract_employee.employee_id, salary: @contract_employee.salary } }
